from .oss.api import OSSImportStorageListAPI, OSSExportStorageListAPI
...
def get_storage_list():
    return [
        {'name': 'oss', 'title': 'ALi OSS', 'import_list_api': OSSImportStorageListAPI, 'export_list_api': OSSExportStorageListAPI},
